...
\begin{document}
	...
	Per effettuare la cifratura dei dati è, ovviamente, necessario che prima avvenga uno scambio delle chiavi. Uno dei problemi che rimane è la memorizzazione delle chiavi, ma questo coincide con il problema più generale e già citato (\ref{sec:threat_model}) riguardante la sicurezza dei dati relativi alla VM memorizzati su disco.
