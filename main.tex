...
\begin{document}
	...
	Fino ad ora il normale modello di minaccia relativo al cloud computing ha richiesto di considerare come fidato l'hypervisor, il quale ha sempre accesso ai dati delle macchine virtuali che ospita in quanto gestore della memoria fisica.
	...
	Questa soluzione è stata scartata per motivi di performance, come già menzionato precedentemente. La soluzione effettivamente implementata è quella presentata nella sezione \ref{sec:critt}.
	...
	Per i test sono stati adeguati due programmi presenti tra gli esempi di Trusted Application forniti da OP-TEE \cite{optee_examples}. Il primo, \texttt{test\_1}, si tratta di un programma che riempie un buffer fornito dal REE con valori casuali prima di restituirlo, mentre il secondo, \texttt{test\_2}, si occupa semplicemente di incrementare un valore. Sono basati, rispettivamente, sui programmi \textit{random} ed \textit{hello\_world} di OP-TEE.
	...
	\begin{table}[h]
		...
		\begin{tabular}{ccccccc}
			...
			\texttt{test\_1}          & 4,048     & 0,197     & 4,100     & 0,176     & 6,357     & 0,252     \\
			\texttt{test\_2}    & 2,189     & 0,139     & 4,560     & 0,203     & 5,655     & 0,218     \\
		\end{tabular}
		...
		\begin{tabular}{ccc}
			...
			\hline
			\texttt{test\_1}        & 1,288\%   & 57,033\%  \\
			\texttt{test\_2}  & 108,32\%  & 158,33\%  \\
		\end{tabular}
