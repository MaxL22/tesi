...
\begin{document}
	...
	Nella nostra implementazione non è stato fatto, ma sarebbe teoricamente possibile integrare il processo di cifratura della chiamata e decifratura della risposta all'interno dei driver virtuali per il TEE così da semplificarne l'utilizzo, ma non si può avere una soluzione simile all'interno della TA, che quindi richiederà delle modifiche.
	...
	%Commentare i risultati, perché alcuni sono 4% altri 100%
	Sviluppo e test sono stati effettuati su una macchina virtuale QEMU ... 
