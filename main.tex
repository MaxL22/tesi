...
\begin{document}
	...
	\section{Passthrough per TEE tra QEMU e Linux}
	\label{sec:passthrough}
	In ambiente cloud potrebbe sembrare una soluzione efficace l'utilizzo di un TEE per garantire integrità e confidenzialità dei dati, ma le possibilità di utilizzo dei Trusted Execution Environment all'interno di ambienti virtualizzati risultano limitate. Però questo generalmente richiede un TEE dedicato per ogni cliente, il quale dovrebbe essere in grado di gestirlo. 
