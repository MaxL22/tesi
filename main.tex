...
\begin{document}
	...
	\label{subsec:architettura}
 	Le specifiche di GlobalPlatform non si riferiscono a implementazioni specifiche riguardanti l'architettura, ma piuttosto delineano una struttura generale degli elementi logici costituenti il TEE e le loro interazioni.
