...
\begin{document}
	...
	Da qui in poi l'hypervisor verrà quindi considerato come \textit{untrusted} e l'obiettivo delle soluzioni presentate sarà quello di rendergli inaccessibili i dati relativi alle VM.
